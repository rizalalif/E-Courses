    ...
    <section class="mb-16 antialiased bg-white dark:bg-gray-900">
        <div class="mx-auto 2xl:px-0 item">
            <div class="relative px-4 py-8 bg-center bg-cover dark:bg-gray-800"
                ...
                <div class="relative z-10 max-w-screen-xl mx-auto lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                    <div class="max-w-md mx-auto my-auto shrink-0 lg:max-w-lg">
                        <img class="w-full " src="{{ asset('assets/img/corosel.jpg') }}" alt="" />
                    </div>
                    <div class="mt-6 sm:mt-8 lg:mt-0">
                        ...
                        <div class="mt-1 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                            <a href="{{ route('user.checkout') }}" title=""
                        ...
                        <p class="mb-6 text-gray-900 dark:text-gray-400">
                            Program yang dibuat dengan menggunakan bahasa pemrograman web
                            seperti HTML, CSS, JavaScript, dan PHP. Dengan menggunakan framework
                            Laravel, program ini dapat dibuat dengan lebih mudah dan cepat.
                        </p>

                        <p class="text-gray-900 dark:text-gray-400">
                            Program ini juga dilengkapi dengan fitur-fitur seperti autentikasi
                            user, validasi data, dan pengamanan data. Dengan demikian, program
                            ini dapat dijamin keamanannya dan kenyamanan dalam penggunaannya.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
                ...
                <div class="p-5 mt-12 rounded-lg shadow-md dark:bg-gray-800"
                    style="background-image: url('{{ asset('assets/img/bg.png') }}');">

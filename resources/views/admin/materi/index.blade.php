                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        {{ Str::words(
                                            'Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium ipsa dignissimos eligendi voluptas, dolorum atque nostrum tempore cumque aperiam modi voluptate tempora? Incidunt harum voluptatem dolore veniam aspernatur nostrum eius?',
                                            10,
                                        ) }}
                                    </td>

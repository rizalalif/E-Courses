                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{$transaction->buyer_name}}</td>
                                <td class="px-4 py-3">{{$transaction->buyer_phone_number}}</td>
                                <td class="px-4 py-3">{{$transaction->quantity}}</td>
                                <td class="px-4 py-3">{{$transaction->total_price}}</td>
                                <td class="px-4 py-3">{{$transaction->status}}</td>
                                <td class="flex items-center justify-end px-4 py-3">
                                    <button id="{{$transaction->id}}-dropdown-button"
                                        data-dropdown-toggle="{{$transaction->id}}-dropdown"
                                    ...
                                    <div id="{{$transaction->id}}-dropdown"
                                        class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            aria-labelledby="{{$transaction->id}}-dropdown-button">
                                            <li>

                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">Disscount</th>
                            ...
                            <tbody>
                                @foreach ($paket as $item)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">{{ $item->paket_kategori->name }}</td>
                                        <td class="px-4 py-3">{{ $item->paket_type }}</td>
                                        <td class="px-4 py-3">Rp. {{ number_format($item->price, 0, ',', '.') }}</td>
                                        <td class="px-4 py-3">{{ $item->discount }}%
                                        </td>
                                        <td class="px-4 py-3">{{ $item->day_active_paket }} Days</td>
                                        <td class="px-4 py-3">{{ $item->status }}</td>
                                        <td class="flex items-center justify-end px-4 py-3">
                                            <button id="{{ $item->id }}-27-dropdown-button"
                                                data-dropdown-toggle="{{ $item->id }}-27-dropdown"

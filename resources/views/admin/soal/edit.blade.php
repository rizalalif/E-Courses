    ...
    <section class="p-3 bg-gray-50 dark:bg-gray-900 sm:p-5">
        <form action="{{ route('soal.update', $soal->id) }}" method="POST">
            ...
            <div class="max-w-full px-4 py-4 mx-auto rounded-md lg:py-5 dark:bg-gray-800">
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Soal</h2>
                    ...
                    <div class="sm:col-span-2 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4 sm:col-span-2 ">
                            ...
                            <button type="button" data-modal-target="editModal" data-modal-toggle="editModal"
                                class="text-white inline-flex justify-center items-center bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:focus:ring-yellow-900 w-full">
                                Save Change
                            </button>
                            <!-- edit modal -->

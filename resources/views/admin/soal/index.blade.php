                ...
                <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                    <div
                        ...
                        <div
                            ...
                            <a type="button" id="defaultModalButton" data-modal-target="defaultModal"
                                data-modal-toggle="defaultModal" href="{{ route('soal.create') }}"
                    ...
                    <div class="p-10 overflow-x-auto ">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400" id="pagination-table">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th scope="col"
                                        class="px-4 py-3 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                        Nama</th>
                                    <th scope="col"
                                        class="px-4 py-3 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                        Durasi</th>
                                ...
                                @foreach ($soal as $item)
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row"
                                            ...
                                            {{ $item->name }}</th>
                                        <td class="px-4 py-3">{{ $item->waktu_pengerjaan }}</td>
                                        <td class="px-4 py-3">{{ $item->jumlah_soal }}</td>
                                        <td class="px-4 py-3">{{ Str::words($item->description, 10, ' ...') }}</td>
                                            ...
                                            <div id="{{ $item->id }}-dropdown"
                                                ...
                                                <div class="py-1">
                                                    <button id="deleteSoalBtn" value="{{ $item->id }}"
                                                        ...
                                                        data-modal-toggle="deleteModal">Delete</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '#deleteSoalBtn', function(e) {
                e.preventDefault();
                var id = $(this).val();
                var actionUrl = "{{ route('soal.destroy', ':id') }}";
